...
const DICTIONARY_AR = {
  ...
  "Pick your preferred date and time online or connect instantly via WhatsApp for same-day scheduling.": "حدد التاريخ والوقت المناسب لك عبر الإنترنت أو تواصل فوراً عبر واتساب للمواعيد العاجلة.",
  "Step 3: Thorough Clinical Consultation": "الخطوة 3: استشارة سريرية دقيقة",
  "Step 3: Comprehensive Consultation": "الخطوة 3: تشخيص سريري دقيق",
  "Meet with our licensed physician in a private, welcoming environment for comprehensive medical evaluation.": "قابل طبيبك المرخص في بيئة علاجية مريحة وخاصة للحصول على تشخيص دقيق وتقييم شامل.",
  "Step 4: Tailored Care & Follow-Up": "الخطوة 4: خطة علاجية مخصصة ومتابعة",
  "Step 4: Tailored Treatment & Care": "الخطوة 4: خطة علاجية ومتابعة",
  "Receive a transparent, personalized treatment plan with post-consultation guidance and support.": "احصل على خطة علاج واضحة ومخصصة لحالتك مع إرشادات ما بعد الاستشارة والمتابعة المستمرة.",

  // Consultation Estimator / Calculator
  "Transparent Healthcare Pricing": "أسعار رعاية صحية واضحة وشفافة",
  "Consultation & Treatment Fee Estimator": "حاسبة تكلفة الاستشارات والعلاج الطبي",
  "Select a medical service to estimate consultation and procedure fees:": "اختر الخدمة الطبية لتقدير تكلفة الاستشارة والعلاج:",
  ...
  "PRP Hair Fall Treatment": "علاج تساقط الشعر بالبلازما (PRP)",
  "Facial PRP Glow & Rejuvenation": "نضارة ونقاء الوجه بالبلازما",
  "Outpatient Wound Care & Stitches": "العناية بالجروح والغرز الطبية",
  "Antenatal Prenatal Checkup": "فحص ومتابعة الحمل",
  "Urogenital & Wellness Evaluation": "استشارة الجهاز البولي والذكورة",
  "Any Available Licensed Doctor": "أي طبيب مرخص متاح",
  "Included": "مشمول",
  ...
  "Morning (9:00 AM - 1:00 PM)": "الفترة الصباحية (9:00 ص - 1:00 م)",
  "Evening (4:00 PM - 10:00 PM)": "الفترة المسائية (4:00 م - 10:00 م)",
